...
logging.config.fileConfig('./sensors/MMA8451/logging.conf')
...
#~ BCM2708_COMBINED_PARAM_PATH = '/sys/module/i2c_bcm2835/parameters/combined'
...
class MMA8451(object):
    ...
    def __init__(self, address=DEFAULT_ADDRESS, bus=None,
                 sensor_range=RANGE_2G, data_rate=BW_RATE_400HZ, debug=False):
        if debug:
    ...
    def read_byte_data(self, register):
        ...
        Returns:
            Data read.
        """
        time.sleep(0.0001) # determines the samples rate to some extent
...
if __name__ == "__main__":
    ...
    while True:
        ...
        #~ sys.stdout.write("\033[F \033[K \033[F \033[K \033[F \033[K \033[F \033[K \033[F \033[K") # Cursor up
